...
(function(a) {
  ...
  function O(a, b, c, d) {
    ...
    return (
      ...
      b
        ...
        : (f.setFullYear(a[0], a[1], a[2]), f.setHours(a[3], a[4], a[5], a[6])),
      (f._a = g),
      f
    );
  }
  function P(a, c) {
    ...
    for (d = 0; d < 12; d++)
      (e = b([2e3, d])),
        (g[d] = new RegExp(
          `^${c.months[d] || c.months(e, '')}|^${(
            c.monthsShort[d] || c.monthsShort(e, '')
          ).replace('.', '')}`,
          'i'
        ));
  ...
  function Q(a) {
    const c = (typeof a === 'string' && a) || (a && a._lang) || null;
    return c ? f[c] || P(c) : b;
  }
  function R(a) {
  ...
  function Z(a, b, c, d, e) {
    const f = e.relativeTime[a];
    return typeof f === 'function'
      ? f(b || 1, !!c, a, d)
      : f.replace(/%d/i, b || 1);
  }
  function $(a, b, c) {
    let e = d(Math.abs(a) / 1e3),
      f = d(e / 60),
      g = d(f / 60),
      h = d(g / 24),
      i = d(h / 365),
  ...
  function _(a, c) {
    b.fn[a] = function(a) {
      const b = this._isUTC ? 'UTC' : '';
      return a != null
        ? (this._d[`set${b}${c}`](a), this)
        : this._d[`get${b}${c}`]();
    };
  }
  function ab(a) {
  ...
  var b,
    ...
    D = {
      ...
      DDD() {
        let a = new Date(this.year(), this.month(), this.date()),
  ...
  (D.DDDD = F(D.DDD, 3)),
    (b = function(c, d) {
      ...
      let e, f;
      return b.isMoment(c)
        ? new H(new Date(+c._d), c._isUTC, c._lang)
        : (d
            ? M(d)
              ? (e = X(c, d))
              : (e = W(c, d))
    ...
    (b.duration = function(a, c) {
      let d = b.isDuration(a),
        e = typeof a === 'number',
        f = d ? a._data : e ? {} : a,
        g;
      return (
        e && (c ? (f[c] = a) : (f.milliseconds = a)),
        (g = new I(f)),
        d && (g._lang = a._lang),
        g
      );
    ...
    (b.fn = H.prototype = {
      ...
      isValid() {
        return this._a
          ? this._a[8] != null
            ? !!this._a[8]
            : !N(this._a, (this._a[7] ? b.utc(this._a) : b(this._a)).toArray())
      ...
      format(a) {
        return T(this, a || b.defaultFormat);
      },
      add(a, c) {
        const d = c ? b.duration(+c, a) : b.duration(a);
      ...
      diff(a, c, e) {
        let f = this._isUTC ? b(a).utc() : b(a).local(),
      ...
      isDST() {
        return (
          this.zone() < b([this.year()]).zone() ||
          this.zone() < b([this.year(), 5]).zone()
        );
      },
      day(a) {
  ...
  _('year', 'FullYear'),
    (b.duration.fn = I.prototype = {
      ...
      humanize(a) {
        ...
        return (
          a &&
            (typeof e === 'function' ? (d = e(d)) : (d = e.replace(/%s/i, d))),
          d
        );
      },
      lang: b.fn.lang,
  ...
  bb('Weeks', 6048e5),
    ...
    typeof define === 'function' && define.amd && define('moment', [], () => b);
}.call(this));
